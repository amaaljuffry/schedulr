    ...
    <>
      <div className="flex items-center justify-between px-2">
        <div className="sm:grid gap-1 hidden">
          <h1 className="font-heading text-3xl md:text-4xl text-[#000] text-primary ">Category</h1>
          <p className="text-lg text-muted-foreground">
            Create and manage your event categories.
          </p>
        </div>
        <Button asChild>
      ...
      {data.EventType.length === 0 ? (
        <EmptyState
          title="You have no Event Categories"
